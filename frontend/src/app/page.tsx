      ...
      <div className="mt-8 flex flex-col items-center space-y-6">
        {user ? (
          <div className="text-center">
            ...
            <button className="mt-6 px-6 py-3 bg-red-500 hover:bg-red-600 text-white font-bold rounded-lg shadow-lg transform transition duration-200 hover:scale-105 focus:outline-none"
              onClick={logout}
            >
              Logout
            </button>
